/* =========================================================
   🐔 KODE SUMBER: MANAJEMEN KESEHATAN AYAM & VAKSINASI
   File: kesehatanayam.js
   ---------------------------------------------------------
   Deskripsi singkat:
   File ini mengelola sistem pencatatan rekam medis, kesehatan ayam,
...
// =========================================
// 2. INISIALISASI PROGRAM & FETCH DATA
// =========================================
...
/**
 * Menyimpan data pencatatan rekam medis (Kesehatan) ke Firestore.
...
/**
 * Fungsi utilitas untuk memicu proses download file CSV pada browser klien.
 * @param {string} csv - String teks berformat CSV
