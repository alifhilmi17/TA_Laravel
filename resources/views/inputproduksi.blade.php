...
@section ('content')
    ...
    <link
        rel="stylesheet"
        href="{{ asset('css/inputproduksi/inputproduksi.css') }}"
    />
    <link
        rel="stylesheet"
    ...
    <section
        class="quick-stats produksi-stats animate__animated animate__fadeInUp"
    >
        <div class="stat-card">
            ...
            <div class="table-header">
                ...
                <div class="table-actions">
                    ...
                    <button
                        ...
                        title="Unduh Laporan Data Produksi"
                    >
                        📥 Ekspor CSV
                    </button>
                </div>
            ...
            <form id="produksiForm" onsubmit="saveProduksiData(event)">
                ...
                <div class="form-group">
                    ...
                    <small class="hint-text"
                        >*Data batch diambil dari halaman Data Ayam</small
                    >
                </div>
                ...
                <div class="form-group" id="inputModeGroup">
                    ...
                    <div class="mode-toggle-container">
                        <button
                            ...
                            onclick="switchInputMode('harian')"
                        >
                            📅 Harian (1 Hari)
                        </button>
                        <button
                            ...
                            id="btnModeMingguan"
                            class="mode-btn"
                            onclick="switchInputMode('mingguan')"
                        >
                            📊 Mingguan (7 Hari)
                        </button>
                    </div>
                ...
                <div class="form-group" id="tglProduksiGroup">
                    <label for="tglProduksi" id="labelTglProduksi"
                    ...
                    <input
                        ...
                        id="tglProduksi"
                        required
                        title="Pilih tanggal pencatatan produksi"
                        onchange="onStartDateChange()"
                    />
                    <small class="hint-text" id="tglHint"
                        >📅 Pilih tanggal produksi (default: Hari Ini)</small
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input
                        type="hidden"
                        id="kandangProduksiHidden"
                        name="kandangProduksiHidden"
                    />
                    <input
                        type="text"
                        id="kandangProduksi"
                        readonly
                        placeholder="— otomatis dari batch —"
                        style="
                    ...
                    />
                    <small class="hint-text" id="kandangHint"
                        >⬆️ Terisi otomatis saat batch dipilih</small
                    >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        title="Terisi otomatis dari data batch yang dipilih"
                    />
                    <small class="hint-text" id="jenisHint"
                        >⬆️ Terisi otomatis saat batch dipilih</small
                    >
                </div>
                        ...
                        <div style="flex: 1">
                            ...
                            <input
                                ...
                                style="
                                    ...
                                    font-size: 0.95rem;
                                "
                                title="Mati otomatis memotong populasi"
                            />
                        </div>
                    </div>
                    ...
                    >
                        ...
                        <small
                            ...
                            style="
                                ...
                                color: #64748b;
                            "
                            >*Memotong stok pakan & tercatat ke Modul
                            Pakan</small
                        >
                    </div>
                </div>
                ...
                <div id="weeklyFieldsContainer" style="display: none">
                    <div class="form-group" style="margin-bottom: 10px">
                        ...
                        <small
                            ...
                            "
                        >
                            Masukkan data produksi telur harian dan jumlah
                            kematian ayam harian selama satu minggu
                            berturut-turut. Tanggal tiap baris terhitung
                            otomatis dari tanggal mulai yang Anda pilih di atas.
                            Kematian akan langsung tercatat ke Modul Kesehatan
                            dan memotong populasi.
                        </small>
...
@push ('scripts')
    ...
    <script
        type="module"
        src="{{ asset('js/inputproduksi/inputproduksi.js') }}"
    ></script>
@endpush
