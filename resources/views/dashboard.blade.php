...
@section ('content')
    ...
    <section class="welcome-card animate__animated animate__fadeInDown">
        <h2>
            Selamat Datang Kembali, {{ Auth::user()->name ?? 'Peternak' }}! 🐣
        </h2>
        ...
        <div class="widget-card-purple">
            ...
            >
                ...
                <div>
                    ...
                    <p style="
                            ...
                            opacity: 0.9;
                            color: #fff;
                        ">Operasi harian dalam satu klik</p>
                </div>
            </div>
            ...
            <button
                ...
                onclick="
                    Swal.fire(
                        'Rekap Harian',
                        'Menampilkan rekapitulasi harian',
                        'info',
                    )
                "
                class="qa-recap-btn"
        ...
        <div class="widget-card-cyan">
                ...
                >
                    ...
                    <div>
                        ...
                        <p style="
                                ...
                                opacity: 0.9;
                                color: #fff;
                            ">Semua jadwal vaksin sudah selesai</p>
                    </div>
                </div>
            ...
            >
                <p style="
                        ...
                        line-height: 1.5;
                        margin: 0;
                    ">Tidak ada jadwal vaksinasi mendatang. Semua vaksin sudah selesai.</p>
            </div>
        </div>
    </section>
@endsection
...
@push ('scripts')
    ...
    <script
        type="module"
        src="{{ asset('js/dashboard/dashboard.js') }}"
    ></script>
    @if (session('success'))
        <script>
