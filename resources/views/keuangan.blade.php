        ...
        <section class="finance-form-card shadow-card">
            ...
            <form id="financeForm">
                ...
                <div class="form-group" id="trxSourceGroup">
                    ...
                    <div class="mode-toggle-container">
                        <button
                            ...
                            onclick="switchTrxSource('manual')"
                        >
                            ✍️ Manual / Umum
                        </button>
                        <button
                            type="button"
                            id="btnSourceProduksi"
                            class="mode-btn"
                            onclick="switchTrxSource('produksi')"
                        >
                            🥚 Hasil Produksi
                        </button>
                    </div>
                ...
                <div class="form-group" id="batchFormGroup">
                    <label for="trxBatch" id="lblTrxBatch"
                        >Target Batch Ayam
                ...
                <div id="produksiSourceFields" style="display: none">
                    <div class="form-group">
                        ...
                        <select
                            id="trxWeek"
                            disabled
                            onchange="showWeekProductionSummary()"
                        >
                    ...
                    <div
                        id="weeklyProductionSummary"
                        class="weekly-summary-card animate__animated animate__fadeIn"
                        style="display: none"
                    >
                        ...
                        <div class="summary-periode-widget">
                            <span class="widget-label"
                                >📅 Periode Produksi</span
                            >
                            <strong id="summaryPeriode" class="widget-val"
                                >-</strong
                            >
                        </div>
                        ...
                        <div class="summary-widgets-grid">
                            ...
                            <div class="mini-widget widget-baik">
                                ...
                                <div class="widget-info">
                                    ...
                                    <strong id="summaryBaik" class="widget-val"
                                        >0 Butir</strong
                                    >
                                </div>
                            </div>
                            ...
                            <div class="mini-widget widget-cacat">
                                ...
                                <div class="widget-info">
                                    <span class="widget-label"
                                        >Telur Cacat</span
                                    >
                                    <strong id="summaryCacat" class="widget-val"
                                        >0 Butir</strong
                                    >
                                </div>
                            </div>
                            ...
                            <div class="mini-widget widget-total">
                                ...
                                <div class="widget-info">
                                    <span class="widget-label"
                                        >Total Telur</span
                                    >
                                    <strong id="summaryTotal" class="widget-val"
                                        >0 Butir</strong
                                    >
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            inputmode="numeric"
                            oninput="
                                window.formatNumberInput(this);
                                calculateEggSalesAmount();
                            "
                            placeholder="Contoh: 50.000"
                        />
                        <small class="hint-text"
                            >💡 Jumlah Uang akan terhitung otomatis: (Telur Baik
                            / 30) × Harga per Papan</small
                        >
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input
                        type="text"
                        id="trxDesc"
                        placeholder="Contoh: Penjualan 50 Papan Telur"
                        required
                    />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        oninput="
                            window.formatNumberInput(this);
                            window.calculateEggPriceFromAmount();
                        "
                ...
                <div class="table-filters">
                    ...
                    <div class="filter-group">
                        ...
                        <select
                            ...
                            "
                        >
                            <option value="riwayat-keseluruhan" selected>
                                📅 Riwayat Keseluruhan
                            </option>
                            <option value="tipe">
