...
@section ('content')
    ...
    <link
        rel="stylesheet"
        href="{{ asset('css/restockpakan/restockpakan.css') }}"
    />
    ...
    <div class="live-stock-widget animate__animated animate__fadeInUp">
        ...
        <div class="widget-grid" id="liveStockGrid">
            <div
                class="empty-state"
                style="grid-column: 1/-1; padding: 10px; text-align: center"
            >
                <p style="
                        margin: 0;
                        color: #64748b;
                        font-size: 0.85rem;
                    ">Memuat data stok pakan riil...</p>
            </div>
        </div>
    </div>
    ...
    >
        <div class="shadow-card" style="padding: 20px">
            ...
            <div class="tabs-container">
                ...
                >
                    ⏳ Butuh Restock
                    <span class="tab-badge count-zero" id="badgePendingCount"
                        >0</span
                    >
                </button>
                <button
                ...
                >
                    ✅ Riwayat Restock
                    <span class="tab-badge count-zero" id="badgeSelesaiCount"
                        >0</span
                    >
                </button>
            </div>
            ...
            <form id="reminderForm" onsubmit="saveReminder(event)">
                ...
                <div class="form-group">
                    ...
                    <input
                        type="text"
                        id="jenisPakan"
                        placeholder="Contoh: Konsentrat BP11"
                        required
                    />
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea
                        id="catatan"
                        rows="3"
                        placeholder="Contoh: Pesan 50 karung ke Supplier A"
                    ></textarea>
                </div>
...
@push ('scripts')
    ...
    <script
        type="module"
        src="{{ asset('js/restockpakan/restockpakan.js') }}"
    ></script>
@endpush
