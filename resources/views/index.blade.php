...
<head>
    ...
    <meta
        name="description"
        content="Lintau Buo Administration System - Portal Profesional Peternakan"
    />
...
<body>
    ...
    <main class="hero-container">
        <div class="hero-glass">
            ...
            <div
                class="brand-icon"
                style="font-size: 42px; line-height: 1; user-select: none"
            >
                🐔
            </div>
            ...
            <h1 class="welcome-title">
                Selamat Datang di <span class="gradient-text">LIBAS</span>
            </h1>
            ...
            <div class="auth-buttons">
                ...
                <a
                    ...
                    title="Daftar sebagai Petugas Baru"
                >
