            ...
            <div class="login-card" id="loginCard">
                ...
                <div class="card-face card-front">
                    ...
                    <p class="subtitle" style="
                            margin-bottom: 24px;
                        ">Silakan pilih peran Anda untuk masuk ke portal administrasi LIBAS.</p>

                    <div class="role-selection-group">
                        <!-- Tombol Pilih Petugas -->
                        <button
                            type="button"
                            class="role-btn role-btn-petugas"
                            id="btnRolePetugas"
                        >
                            <div class="role-icon">👨‍🌾</div>
                            <div class="role-info">
                                <span class="role-title"
                                    >Masuk sebagai Petugas</span
                                >
                                <span class="role-desc"
                                    >Operator kandang & pencatat harian</span
                                >
                            </div>
                        ...
                        >
                            ...
                            <div class="role-info">
                                <span class="role-title"
                                    >Masuk sebagai Admin</span
                                >
                                <span class="role-desc"
                                    >Pengelola utama & Pemilik peternakan</span
                                >
                            </div>
                            <div class="role-arrow">→</div>
                        </button>
                ...
                <div class="card-face card-back">
                    ...
                    <h2 id="formTitle" style="margin-top: 10px">
